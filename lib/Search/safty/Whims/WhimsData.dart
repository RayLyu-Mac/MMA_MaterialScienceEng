...
List<WHIMSData> whims = [
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Biohazardous Infectious Materials (Organisms can cause diseases)",
      content:
  ...
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Gas Cylinder (Gases under pressure)",
      content:
  ...
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Corrosion (Can cause corrosive damage)",
      content:
  ...
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Skull & Crossbones (Dangerous even small amounts)",
      content:
  ...
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Environment (Danger to aquatic environment)",
      content:
  ...
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Health Hazard (May cause serious health effects)",
      content:
  ...
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Flame Over Circle (Oxidizing hazards)",
      content:
  ...
  (WHIMSData(
      picLeft: 10,
      titleFontsize: 13,
      title: "Exploding Bomb (Explosive or reactivity hazards)",
      content:
